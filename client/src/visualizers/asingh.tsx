...
export const RippleVisualizer = new Visualizer("Ripple Visualizer", (p5: P5, analyzer: Tone.Analyser) => {
  ...
  p5.background(0);
  p5.noFill();
  p5.circle(x - x + offset_pos * 2, y, 20);
  p5.circle(x - x + offset_pos * 2, y, 40);
  p5.circle(x - x + offset_pos * 2, y, 60);
  p5.circle(x - x + offset_pos * 2, y, dia);
  p5.circle(x, y, 20);
  p5.circle(x, y, 40);
  p5.circle(x, y, 60);
  p5.circle(x, y, dia);
  p5.circle(x + x - offset_pos * 5, y, 20);
  p5.circle(x + x - offset_pos * 5, y, 40);
  p5.circle(x + x - offset_pos * 5, y, 60);
  p5.circle(x + x - offset_pos * 5, y, dia);
