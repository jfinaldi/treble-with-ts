...
export const _Cat = new Instrument("Cat", Cat);
...
// function CatType({ title, onClick, active }: any): JSX.Element {
//   return (
//     <div
//       onClick={onClick}
...
// function Cat({ synth, setSynth }: InstrumentProps): JSX.Element {
//   const keys = List([
//     { note: 'C', idx: 0 },
//     { note: 'Db', idx: 0.5 },
//     { note: 'D', idx: 1 },
...
// export const CatInstrument = new Instrument('Cat', Cat);
