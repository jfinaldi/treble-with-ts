  ...
  useEffect(() => {
    setSongs(
      state
        .get("songs", List())
        .reduce(
          (acc: any, song: any) => acc.concat([song.get("songTitle")]),
          [] as any[]
        )
    );
  }, [state]);
    ...
    <div>
      ...
      <Section title="Jukebox">
        {visible ? (
          <div
            className={classNames(
              "pt2 shadow-6 ba bsblk bg-moon-gray pl0 pr0 pb3 pt1 dib-ns"
            )}
          >
            <Combobox
              hideCaret
            ...
            <div className={classNames("ml3-ns pl1")}>
              <input
                className={classNames(
                  "h2 mr1-ns b-m green bg-white-60 bsblk br3 pl2 pr2 pt1 pb3 tc no-underline dib-ns f5-ns mt00-m mb00-m ml00-m mr00-m pointer:hover"
                )}
                id="play"
                type="button"
                value="Play"
              ...
              <input
                className={classNames(
                  "h2 mr1-ns b-m black bg-white-60 bsblk br3 pl2 pr2 pt1 pb3 tc no-underline dib-ns f5-ns mt00-m mb00-m ml00-m mr00-m pointer:hover"
                )}
                id="pause"
                type="button"
                value="Pause"
              ...
              <input
                className={classNames(
                  "h2 b-m red bg-white-60 bsblk br3 pl2 pr2 pt1 pb3 tc no-underline dib-ns f5-ns mt00-m mb00-m ml00-m mr00-m pointer:hover"
                )}
                id="stop"
                type="button"
                value="Stop"
            ...
            <div className={classNames("ml2-ns pl2")}>
              ...
              ></input>
              <input
                className={classNames("mt1-ns br3 ml1-ns")}
                id="reset"
                type="button"
                value="Reset Song"
              ></input>
            ...
            <div className={classNames("ml0-ns pl2")}>
              <form action="http://www.google.com">
                <input
                  className={classNames(
                    "tc ml2-ns br2-m f5-m tc-l w-90 mt1-ns"
                  )}
                  id="text"
                  type="text"
                  name="new_song_title"
